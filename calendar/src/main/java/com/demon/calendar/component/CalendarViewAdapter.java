package com.demon.calendar.component;
...
public class CalendarViewAdapter extends PagerAdapter {
    ...
    public CalendarViewAdapter(Context context, OnSelectDateListener onSelectDateListener, IDayRenderer dayView) {
        super();
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        if (calendarType == CalendarAttr.CalendarType.MONTH) {
            ...
            if (weekArrayType == CalendarAttr.WeekArrayType.Sunday) {
                calendar.showDate(CalendarUtil.getSaturday(current));
            } else {
                calendar.showDate(CalendarUtil.getSunday(current));
            }//每周的种子日期为这一周的最后一天
