...
import com.demon.calendar.behavior.MonthPagerBehavior;
...
public class MonthPager extends ViewPager {
    ...
    public MonthPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.MonthPager);
        rowIndex = a.getInteger(R.styleable.MonthPager_mp_row, 6);
        a.recycle();
        init();
    }
